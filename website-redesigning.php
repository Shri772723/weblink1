...
<head>
    ...
    <title>Website Redesigning | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h1 class="text-white breadcrumb-heading">Website Redesigning</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Website Redesigning</li>
                </ol>
            </nav>
        </div>
    ...
    <section class="services-description-section position-relative py-5" id="Website-Redesigning">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is in Website Redesigning?
                </h3>
            ...
            <div class=" col-xl-3 col-lg-3 col-md-3 sidebar-nav" style="">
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                        ...
                        <a class="current" href="website-redesigning.php">
                                                ...
                                                <div class="py-3 p-lg-3">
                                                    <div class="row mb-5" data-aos="fade-right">
                                                        ...
                                                        <div
                                                            ...
                                                            <h2 class="h3 sub-heading-services-part">A little
                                                                change........makes big difference!!s</h2>
                                                            <p class="text-services text-justify "><strong>
                                                                    Can you imagine how many visitors and how much of
                                                                    business you are losing because of your website that
                                                                    looks outdated?
                                                                </strong> <br>

                                                                Has your site been around for awhile, with the same look
                                                                and feel it always had? Internet users are most
                                                                interested in site with clean, simple and fast designs.
                                                            </p>
...
$(document).ready(function() {
    ...
    $('html, body').animate({
        scrollTop: $('#Website-Redesigning').offset().top - 100
    }, 'slow');
});
</script>
