...
<head>
    ...
    <title>Windows Web Hosting | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h2 class="text-white breadcrumb-heading">Windows Web Hosting</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    <li class="breadcrumb-item"><a href="index.php" class="text-white breadcrumb-link">Home</a></li>
                
                    <li class="breadcrumb-item"><a href="domain-and-hosting.php" class="text-white breadcrumb-link">
                          Domain & Hosting </a></li>
                    <li class="breadcrumb-item active text-white" aria-current="page">Windows Web Hosting</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <p class="sub-text">Web Link Services Pvt Ltd Provides Windows Web Hosting Services in Pune on cheapest cost Pune, MH India.</p>
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Windows Web Hosting" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/windows-hosting.png" alt="Windows Web Hosting"
    ...
    <section class="services-description-section position-relative py-5" id="Windows-Web-Hosting">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is in Windows Web Hosting?
                </h3>
            ...
            <div class=" col-xl-3 col-lg-3 col-md-3 sidebar-nav" style="">
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                        <h4 class="text-white text-center pb-2" style="border-bottom:1px dashed white">Domain & Hosting
                        </h4>
                       <a class="current" href="windows-web-hosting.php">
                            <li>Windows Web Hosting </li>
                        </a>
                      
                       <a  href="linux-web-hosting.php">
                            <li>Linux Web Hosting </li>
                        </a>
                        <a  href="domain-name-hosting.php">
                            <li>Domain Name Hosting</li>
                        </a>
                       <a  href="corporate-e-mail-id-service.php">
                            <li>Corporate E-Mail Id Service </li>
                        </a>
                                                ...
                                                <div class="py-3 p-lg-3">
                                                    <div class="row mb-5" data-aos="fade-right">
                                                        ...
                                                        <div
                                                            ...
                                                            <h2 class="h3 sub-heading-services-part">Affordable and reliable web hosting in Pune</h2>
                                                            <p class="text-services text-justify ">We are committed to providing you with high-quality, low cost web hosting for small business and ecommerce websites. We have awesome features that you won't find even on more expensive dedicated web hosting plans. Web hosting with 24/7 email support with control panel to do all your web hosting needs.
                                                                <br> <strong>GET GREAT WINDOWS WEB HOSTING AT AN AFFORDABLE PRICE!</strong>
...
<script>$(document).ready(function () {
    ...
    $('html, body').animate({
        scrollTop: $('#Windows-Web-Hosting').offset().top - 100
    }, 'slow');
});
</script>
