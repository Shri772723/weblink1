...
<head>
    ...
    <title>Short Code Service | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h1 class="text-white breadcrumb-heading">Short Code Service</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Short Code Service</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <p class="sub-text">Web Link Services Pvt Ltd Provides Short Code Service Provider in Pune. We are best company for Short Code services in Pune, MH India.

</p>
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Short Code Service" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/short-code.png" alt="Short Code Service" class="service-vector">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="services-description-section position-relative py-5" id="Short-Code-Service">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is Short Code Service?
                </h3>
            ...
            <div class=" col-xl-3 col-lg-3 col-md-3 py-3 sidebar-nav" style="">
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                        ...
                        <a  class="current" href="short-code-service.php">
...
$(document).ready(function() {
    ...
    $('html, body').animate({
        scrollTop: $('#Short-Code-Service').offset().top - 100
    }, 'slow');
});
</script>
