...
<head>
    ...
    <title>Domain Name Hosting | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h2 class="text-white breadcrumb-heading">Domain Name Hosting</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="domain-and-hosting.php" class="text-white breadcrumb-link">
                          Domain & Hosting </a></li>
                    <li class="breadcrumb-item active text-white" aria-current="page">Domain Name Hosting</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <p class="sub-text">Web Link Services Pvt Ltd Provides Domain Name Hosting Services in Pune on cheapest cost Pune, MH India.</p>
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Domain Name Hosting" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/domain-services.png" alt="Domain Name Hosting"
    ...
    <section class="services-description-section position-relative py-5" id="Domain-Name-Hosting">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is in Domain Name Hosting?
                </h3>
                ...
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                       ...
                       <a  href="linux-web-hosting.php">
                        ...
                        <a class="current" href="domain-name-hosting.php">
...
<script>$(document).ready(function () {
    ...
    $('html, body').animate({
        scrollTop: $('#Domain-Name-Hosting').offset().top - 100
    }, 'slow');
});
</script>
