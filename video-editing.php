...
<head>
    ...
    <title>Video Editing | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h1 class="text-white breadcrumb-heading">Video Editing</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Video Editing</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <p class="sub-text">Web Link Services Pvt Ltd Provides Video Editing Service Provider in Pune. We are best company for Video Editing services in Pune, MH India.
</p>
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Video Editing" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/video-editing.png" alt="Video Editing" class="service-vector">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="services-description-section position-relative py-5" id="Video-Editing">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is Video Editing?
                </h3>
            ...
            <div class=" col-xl-3 col-lg-3 col-md-3 py-3 sidebar-nav" style="">
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                        ...
                        <a  class="current" href="video-editing.php">
                            <li>Video Editing</li>
                        </a>
                        
                        <a href="brochure-designing.php">
                                                ...
                                                <div class="py-3 p-lg-3">
                                                    <div class="row mb-5" data-aos="fade-right">
                                                        ...
                                                        <div
                                                            ...
                                                            <!-- <h2 class="h3 sub-heading-services-part">Get your Custom Logo Designed by the Experts
 </h2> -->
                                                            <p class="text-services text-justify ">
                                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero placeat labore esse natus in voluptates. Nemo maxime accusamus deserunt asperiores provident aliquid nulla in quo error tempore. Architecto, at sapiente!
                                                            </p>
...
$(document).ready(function() {
    ...
    $('html, body').animate({
        scrollTop: $('#Video-Editing').offset().top - 100
    }, 'slow');
});
</script>
