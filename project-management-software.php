...
<head>
    ...
    <title>Project Management Software | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h2 class="text-white breadcrumb-heading">Project Management Software</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Project Management Software</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <p class="sub-text">Web Link Services Pvt Ltd is famous/top/best Project Management Software Development Company in Pune. We develop Project Management Software in Pune as per client requirement Pune, MH India.</p>
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Project Management Software" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/software-development1.png" alt="Project-Management-Software"
    ...
    <section class="services-description-section position-relative py-5" id="Hotel-Management-Software">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is in Project Management Software?
                </h3>
            ...
            <div class=" col-xl-3 col-lg-3 col-md-3 sidebar-nav" style="">
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                        <h4 class="text-white text-center pb-2" style="border-bottom:1px dashed white">Software Development
                        </h4>

                       <a  href="inventory-management-software.php">
                            <li>Inventory Management Software </li>
                        </a>
                        <a  href="stock-management-software.php">
                            <li>Stock Management Software</li>
                        </a>
                        <a  href="clinic-management-software.php">
                            <li> Clinic Management Software</li>
                        </a>
                        <a  href="hotel-management-software.php">
                            <li>Hotel Management Software</li>
                        </a>
                        <a class="current" href="project-management-software.php">
                            <li>Project Management Software </li>
                        </a>
                        <a  href="accounting-billing-software.php">
                            <li>Accounting / Billing Software</li>
                        </a>
                        <a  href="customized-software.php">
                        ...
                        <a  href="coaching-classes-software.php">
                            <li>Coaching Classes Software</li>
                        </a>
                        <a  href="school-management-software.php">
                            <li> School Management Software</li>
                        </a>
                        <a  href="database-software.php">
                            <li> Database Software</li>
                        </a>
                        <a  href="online-offline-software.php">
                            <li>Online / Offline Software</li>
                        </a>
                                                ...
                                                <div class="py-3 p-lg-3">
                                                    <div class="row mb-5" data-aos="fade-right">
                                                        ...
                                                        <div
                                                            ...
                                                            <!-- <h2 class="h3 sub-heading-services-part">Keeping your website up-to-date</h2> -->
                                                            <p class="text-services text-justify ">We Provide web based integrated user-friendly Project Management Software which has end to end solution for all the departments of Project working team.. <br>

Manage distributed project teams online – Create project, tasks, sub-tasks, schedule tasks, assign tasks & sub-tasks to manager and employees, set dependencies, track progress, due date reminders and notifications by email and sms, generate reports, Gantt Charts, automatic invoice generation. <br>
...
<script>$(document).ready(function () {
    ...
    $('html, body').animate({
        scrollTop: $('#Project-Management-Software').offset().top - 100
    }, 'slow');
});
</script>
