...
<head>
    ...
    <title>LinkedIn | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h1 class="text-white breadcrumb-heading">LinkedIn</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">LinkedIn</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <p class="sub-text">Web Link Services Pvt Ltd Provides LinkedIn Marketing/Promotion Company in Pune, Video Marketing/Promotion Company in Pune. We are best company for LinkedIn Video Promotion/Marketing in Pune, MH India.</p>
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="LinkedIn" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/linkedin.png" alt="LinkedIn" class="service-vector">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="services-description-section position-relative py-5" id="LinkedIn">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is LinkedIn?
                </h3>
                ...
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                        <h4 class="text-white text-center pb-2" style="border-bottom:1px dashed white">Other Marketing
                            ...
                            <a  href="facebook-adverts.php">
                            <li>Facebook Adverts </li>
                        </a>
                            <a    href="youtube.php">
                            <li> Youtube</li>
                        </a>
                            <a class="current" href="linkedin.php">
                            <li>LinkedIn </li>
                        </a>
                                                ...
                                                <div class="py-3 p-lg-3">
                                                    <div class="row mb-5" data-aos="fade-right">
                                                        ...
                                                        <div
                                                           ...
                                                           The biggest online video sharing community, LinkedIn experiences a large share of members to target at. Considering this aspect, we take the essential steps to give you the optimum exposure in this online media. LinkedIn adverts are an additional facet related to this platform which is also used for promotional activities.
                                                            </p>
...
$(document).ready(function() {
    ...
    $('html, body').animate({
        scrollTop: $('#LinkedIn').offset().top - 100
    }, 'slow');
});
</script>
