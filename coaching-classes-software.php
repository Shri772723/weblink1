...
<head>
    ...
    <title>Coaching Classes Software | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h2 class="text-white breadcrumb-heading">Coaching Classes Software</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Coaching Classes Software</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <p class="sub-text">Web Link Services Pvt Ltd is famous/top/best Hospital Management Software Development Company in Pune. We develop Hospital Management Software in Pune as per client requirement Pune, MH India.</p>
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Coaching Classes Software" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/software-development1.png" alt="Coaching Classes Software"
    ...
    <section class="services-description-section position-relative py-5" id="Coaching-Classes-Software">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is in Coaching Classes Software?
                </h3>
                <p class="mb-1 text text-white">Web Link Services Pvt Ltd is famous/top/best Coaching Classes Software Development Company in Pune. We develop Coaching Classes Software in Pune as per client requirement Pune, MH India.
                </p>
            </div>
        </div>
                ...
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                       ...
                       <a  href="inventory-management-software.php">
                        ...
                        <a class="current" href="coaching-classes-software.php">
                                                ...
                                                <div class="py-3 p-lg-3">
                                                    <div class="row mb-5" data-aos="fade-right">
                                                        ...
                                                        <div
                                                            ...
                                                            <p class="text-services text-justify ">Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum facere voluptatibus iste blanditiis laboriosam deserunt, adipisci maxime. Repellat iste perferendis nostrum expedita, officia possimus sit odio aut facilis reprehenderit modi?
<p>
                                                            <a class="text-muted"
                                                                href="#">Read
                                                                More</a>
...
<script>$(document).ready(function () {
    ...
    $('html, body').animate({
        scrollTop: $('#Coaching-Classes-Software').offset().top - 100
    }, 'slow');
});
</script>
