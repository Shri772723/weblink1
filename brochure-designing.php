...
<head>
    ...
    <title>Brochure Designing | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h1 class="text-white breadcrumb-heading">Brochure Designing</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item"><a href="graphic-designing.php" class="text-white breadcrumb-link">
                            Graphics Designing </a></li>
                    <li class="breadcrumb-item active text-white" aria-current="page">Brochure Designing</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <p class="sub-text">Web Link Services Pvt Ltd Provides Brochure Designing Service Provider in Pune. We are best company for Brochure Designing services in Pune, MH India.
</p>
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Brochure Designing" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/video-editing.png" alt="Brochure Designing" class="service-vector">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="services-description-section position-relative py-5" id="Brochure-Designing">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is Brochure Designing?
                </h3>
            ...
            <div class=" col-xl-3 col-lg-3 col-md-3 py-3 sidebar-nav" style="">
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                        <h4 class="text-white text-center pb-2" style="border-bottom:1px dashed white">Graphic Designing
                        </h4>
                        <a href="logo-designing.php">
                            <li>Logo Design</li>
                        </a>
                        ...
                        <a class="current"  href="brochure-designing.php">
                                                ...
                                                <div class="py-3 p-lg-3">
                                                    <div class="row mb-5" data-aos="fade-right">
                                                        ...
                                                        <div
                                                            ...
                                                            <h2 class="h3 sub-heading-services-part">Brochure design that creates an impact!

 </h2>
                                                            <p class="text-services text-justify ">
                                                            A well-designed brochure not only tells your client about your product and services; it also boosts your company's overall impression in the minds of your clients. To have the biggest pie of the market share, hence, it is important to have product or service brochures that are elegant and professionally designed.
                                                            </p>
...
$(document).ready(function() {
    ...
    $('html, body').animate({
        scrollTop: $('#Brochure-Designing').offset().top - 100
    }, 'slow');
});
</script>
