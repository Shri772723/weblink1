...
<head>
    ...
    <title>Multi Language Website | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h1 class="text-white breadcrumb-heading">Multi Language Website</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Multi Language Website</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <p class="sub-text">Web Link Services Pvt Ltd is famous/top/best Website Redesigning in Pune. We
                            are Professional and Creative Website Redesigning Company based in Pune offer services to
                            India and Global.</p>
    ...
    <section class="services-description-section position-relative py-5" id="Multi-Language-Website">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is in Multi Language Website?
                </h3>
            ...
            <div class=" col-xl-3 col-lg-3 col-md-3 py-3 sidebar-nav" style="">
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                        ...
                        <a class="current" href="multi-language-website.php">
                                                ...
                                                <div class="py-3 p-lg-3">
                                                    <div class="row mb-5" data-aos="fade-right">
                                                        ...
                                                        <div
                                                            ...
                                                            <h2 class="h3 sub-heading-services-part">Maximize your online potential
</h2>
                                                            <p class="text-services text-justify ">
                                                            In today's connected world organizations need web sites that reach a global audience in their native language.
 <br> 
One of the great advantages of the world wide web is that it reaches a greater audience then you would otherwise reach. But what happens if this market is in another country or your target audience speaks another language? <br>
...
$(document).ready(function() {
    ...
    $('html, body').animate({
        scrollTop: $('#Multi-Language-Website').offset().top - 100
    }, 'slow');
});
</script>
