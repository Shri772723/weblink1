...
<head>
    ...
    <title>Internet Marketing | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h1 class="text-white breadcrumb-heading">Internet Marketing</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Internet Marketing</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Internet Marketing" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/internet-marketing.png" alt="Internet Marketing" class="service-vector">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="services-description-section position-relative py-5" id="Internet-Marketing">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is Internet Marketing?
                </h3>
...
$(document).ready(function() {
    ...
    $('html, body').animate({
        scrollTop: $('#Internet-Marketing').offset().top - 100
    }, 'slow');
});
</script>
