...
<head>
    ...
    <title>Social Media Optimization | Web link Services Pvt. Ltd. | Pune, Maharashtra, India </title>
</head>
...
<header class="commn-header-section position-relative" id="particles-js">
    <div class="container d-flex breadcrumb-customize justify-content-between">
        <h1 class="text-white breadcrumb-heading">Social Media Optimization</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent">
                <li class="breadcrumb-item"><a href="index.php" class="text-white breadcrumb-link">Home</a></li>
                <li class="breadcrumb-item">Services</li>
                <li class="breadcrumb-item active text-white" aria-current="page">Social Media Optimization</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6" data-aos="fade-right">
                <div class="services-content">
                    ...
                    <p class="sub-text">Web Link Services Pvt Ltd Provides Social Media Optimization Service Provider in Pune. We are best company for Social Media Optimization services in Pune, MH India.</p>
                    <button type="button" onclick="showRequestQuoteModal(this)" data-services-name="Social Media Optimization"
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="services-image">
                    <img src="assets-web/images/services/social-media.png    " alt="Social Media Optimization"
...
<section class="why-choose-us-section">
    <div class="why-choose-heading position-relative text-center">
        <div class="container">
            <h2 class="custom-heading position-relative">Social Media Optimization </h2>
                ...
                <div class="row">
                    <div class="col-lg-4   mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="facebook.php" >View More</a>
                            </div>
                    ...
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">Facebook Adverts </h3>
                            <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="facebook-adverts.php">View More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">YouTube</h3>
                            <p class="text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="youtube.php" >View
                                    More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    ...
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">LinkedIn</h3>
                            <p class="text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="linkedin.php" >View
                                    More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
