...
<head>
    ...
    <title>Local Search Engine Optimization | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h1 class="text-white breadcrumb-heading">Local Search Engine Optimization</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Local Search Engine Optimization</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <p class="sub-text">Web Link Services Pvt Ltd is famous/top/best Internet Marketing Company in Pune, Google Promotion SEO Company in Pune. We Provide Google 1st page rank with 100% assurance in Pune, MH India.</p>
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Local Search Engine Optimization" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/internet-marketing.png" alt="Local Search Engine Optimization" class="service-vector">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="services-description-section position-relative py-5" id="Local-SEO">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is Local Search Engine Optimization?
                </h3>
...
$(document).ready(function() {
    ...
    $('html, body').animate({
        scrollTop: $('#Local-SEO').offset().top - 100
    }, 'slow');
});
</script>
