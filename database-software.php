...
<head>
    ...
    <title>Database Software | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h2 class="text-white breadcrumb-heading">Database Software</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Database Software</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Database Software" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/software-development1.png" alt="Database Software"
    ...
    <section class="services-description-section position-relative py-5" id="Database-Software">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is in Database Software?
                </h3>
                <p class="mb-1 text text-white">Web Link Services Pvt Ltd is famous/top/best Database Software Development Company in Pune. We develop Database Software in Pune as per client requirement Pune, MH India.
                </p>
            </div>
        </div>
...
<script>$(document).ready(function () {
    ...
    $('html, body').animate({
        scrollTop: $('#Database-Software').offset().top - 100
    }, 'slow');
});
</script>
