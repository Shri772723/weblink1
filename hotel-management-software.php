...
<head>
    ...
    <title>Hotel Management Software | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h2 class="text-white breadcrumb-heading">Hotel Management Software</h2>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Hotel Management Software</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Hotel Management Software" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/software-development1.png" alt="Hotel Management Software"
    ...
    <section class="services-description-section position-relative py-5" id="Hotel-Management-Software">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is in Hotel Management Software?
                </h3>
                ...
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                       ...
                       <a  href="inventory-management-software.php">
                        ...
                        <a class="current" href="hotel-management-software.php">
...
<script>$(document).ready(function () {
    ...
    $('html, body').animate({
        scrollTop: $('#Hotel-Management-Software').offset().top - 100
    }, 'slow');
});
</script>
