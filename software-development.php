...
<head>
    ...
    <title>Software Development | Web link Services Pvt. Ltd. | Pune, Maharashtra, India </title>
</head>
...
<header class="commn-header-section position-relative" id="particles-js">
    <div class="container d-flex breadcrumb-customize justify-content-between">
        <h1 class="text-white breadcrumb-heading">Software Development</h1>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent">
                <li class="breadcrumb-item"><a href="index.php" class="text-white breadcrumb-link">Home</a></li>
                <li class="breadcrumb-item">Services</li>
                <li class="breadcrumb-item active text-white" aria-current="page">Software Development</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6" data-aos="fade-right">
                <div class="services-content">
                    ...
                    <p class="sub-text">Web Link Services Pvt Ltd is famous/top/best Software Development Company in Pune. We develop software in Pune as per client requirement Pune, MH India..</p>
                    <button type="button" onclick="showRequestQuoteModal(this)" data-services-name="Website Designing"
            ...
            <div class="col-lg-6" data-aos="fade-left">
                <div class="services-image">
                    <img src="assets-web/images/services/software-development.png" alt="Software Development"
                        class="service-vector image-fluid">
                </div>
            </div>
        </div>
    </div>
...
<section class="why-choose-us-section">
    <div class="why-choose-heading position-relative text-center">
        <div class="container">
            <h2 class="custom-heading position-relative">Software Development </h2>
    ...
    <section class=" why-choose-us-section">
        <div class="why-choose-content ">
            <div class="container ">
                <div class="row">
                    <div class="col-lg-4   mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            <!-- <div class="icon">
                                <i class="fa fa-headset"></i>
                            </div> -->
                            <h3 class="sub-heading">Inventory Management Software</h3>
                            <p class="text">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="inventory-management-software.php">View More</a>
                            </div>
                    ...
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">Stock Management Software</h3>
                            <p class="text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="stock-management-software.php.php">View
                                    More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    ...
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">Clinic Management Software</h3>
                            <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="clinic-management-software.php">View More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">Hotel Management Software</h3>
                            <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit. </p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="hotel-management-software.php">View More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">Project Management Software</h3>
                            <p class="text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="project-management-software.php">View More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">Accounting / Billing Software</h3>
                            <p class="text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="accounting-billing-software.php">View More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4   mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">Customized Software</h3>
                            <p class="text">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="customized-software.php">View More</a>
                            </div>
                            <span class="background-overlay"></span>
                    ...
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">CRM Software</h3>
                            <p class="text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="crm-software.php">View
                                    More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    ...
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">Hospital Management Software</h3>
                            <p class="text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. </p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="hospital-management-software.php">View
                                    More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    ...
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">Coaching Classes Software</h3>
                            <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="coaching-classes-software.php">View More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">School Management Software</h3>
                            <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="school-management-software.php">View More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">Database Software</h3>
                            <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="database-software.php">View More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-lg-4 mb-4 col-md-6" data-aos="fade-up">
                        <div class="why-choose-card card card-body h-100 border-0 shadow">
                            ...
                            <h3 class="sub-heading">Online / Offline Software</h3>
                            <p class="text">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                            <div class="text-center pt-1">
                                <a class="portfolio-btn " href="online-offline-software.php">View More</a>
                            </div>
                            <span class="background-overlay"></span>
                        </div>
                    </div>
