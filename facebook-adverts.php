...
<head>
    ...
    <title>Facebook Adverts | Web link Services Pvt. Ltd. | Pune, Maharashtra, India</title>
</head>
...
<main class="page-height">
    <header class="commn-header-section position-relative" id="particles-js">
        <div class="container d-flex breadcrumb-customize justify-content-between">
            <h1 class="text-white breadcrumb-heading">Facebook Adverts</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb bg-transparent">
                    ...
                    <li class="breadcrumb-item active text-white" aria-current="page">Facebook Adverts</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6" data-aos="fade-right">
                    <div class="services-content">
                        ...
                        <p class="sub-text">Web Link Services Pvt Ltd Provides Facebook Adverts Provider in Pune. We are best company for Facebook Advertss in Pune, MH India.</p>
                        <button type="button" onclick="showRequestQuoteModal(this)"
                            data-services-name="Facebook Adverts" data-source="services"
                ...
                <div class="col-lg-6" data-aos="fade-left">
                    <div class="services-image">
                        <img src="assets-web/images/services/facebook-add.png" alt="Facebook Adverts" class="service-vector">
                    </div>
                </div>
            </div>
        </div>
    </section>
    <section class="services-description-section position-relative py-5" id="Facebook-Adverts">
        <div class="container">
            <div class="text-center">
                <h3 class=" text-white">What is Facebook Adverts?
                </h3>
                ...
                <div class="mt-5 fixed-sidebar">
                    <ul class="side-service-product-list">
                        <h4 class="text-white text-center pb-2" style="border-bottom:1px dashed white">Other Marketing
                            ...
                            <a class="current" href="facebook-adverts.php">
...
$(document).ready(function() {
    ...
    $('html, body').animate({
        scrollTop: $('#Facebook-Adverts').offset().top - 100
    }, 'slow');
});
</script>
